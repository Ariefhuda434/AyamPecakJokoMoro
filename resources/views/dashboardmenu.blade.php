...
<div x-data="{ 
    ...
    closeModal() {
        ...
        // Reset data setelah transisi selesai
        setTimeout(() => {
            this.menuToEdit = null;
            this.isEdit = false;
        }, 300);
    ...
    getUpdateAction() {
        if (this.menuToEdit && this.menuToEdit.Menu_id) {
            // Pastikan Anda menggunakan properti ID yang benar (Menu_id)
            return this.updateUrlBase.replace('TEMP_MENU_ID', this.menuToEdit.Menu_id);
        }
        return '{{ route('menu.store') }}';
    }
}" 
class="relative p-4"> 
    ...
    @if ($errors->any())
        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4" role="alert">
            <strong class="font-bold">Kesalahan Validasi Input!</strong>
    ...
    <div x-show="isFormOpen" 
        ...
        <div class="w-full max-w-md relative"> 
            ...
            {{-- <button @click="closeModal()" class="absolute top-0 right-0 p-4 text-gray-500 hover:text-gray-900 transition">
